...
description: 'Multi-tenant AI chatbot platform for wine education. Organizations deploy custom sommeliers backed by structured knowledge bases and vector embeddings, configurable per tenant without code changes.'
date: 2025-01-01
published: true
